...
“合而为赢”讲座预告篇: 口腔健康与疾病预防</title>
    ...
    <script>
        function replaceDoc() {
window.location.replace("./31.php")    </script>
...
"pic/31.png"                     id="activity_pic"></div>
                <div class="UpText">
                    <div>活动名称：
“合而为赢”讲座预告篇: 口腔健康与疾病预防 </div>
                    <div>活动时间：
2020年2月4日 </div>
                    <div>活动主办方：<a href="activity_host.html">
北京大学学生会   </a></div>
                    <div>官方网页链接：<a href=
"https://mp.weixin.qq.com/s/_v2zyzAjty9_CffUrDcssA"            >
https://mp.weixin.qq.com/s/_v2zyzAjty9_CffUrDcssA        </a>
                    </div>
...
“合而为赢”学术文化交流系列讲座旨在整合两部优势资源，通过邀请北京大学本部及医学部各学院、医院的专家学者开办讲座的方式，从学生角度促进两部学术交流和文化相通，助力两部深度融合。
            </div>
            <br><br>
        </div>
        <br>
