...
数院新生晚会</title>
    ...
    <script>
        function replaceDoc() {
window.location.replace("./47.php")    </script>
...
"pic/47.png"                     id="activity_pic"></div>
                <div class="UpText">
                    <div>活动名称：
数院新生晚会 </div>
                    <div>活动时间：
...
数院学生会   </a></div>
                    <div>官方网页链接：<a href=
"https://mp.weixin.qq.com/s/HXSKQSmSIY4yRMrWfFwUJQ"            >
https://mp.weixin.qq.com/s/HXSKQSmSIY4yRMrWfFwUJQ        </a>
                    </div>
