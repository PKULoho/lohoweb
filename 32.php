...
新东方企业密码等你解锁</title>
    ...
    <script>
        function replaceDoc() {
window.location.replace("./32.php")    </script>
...
"pic/32.png"                     id="activity_pic"></div>
                <div class="UpText">
                    <div>活动名称：
新东方企业密码等你解锁 </div>
                    <div>活动时间：
...
北京大学学生会   </a></div>
                    <div>官方网页链接：<a href=
"https://mp.weixin.qq.com/s/5Qt9-poRFRTihHx9DduiBQ"            >
https://mp.weixin.qq.com/s/5Qt9-poRFRTihHx9DduiBQ        </a>
                    </div>
