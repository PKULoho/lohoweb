...
男生节 · 趣味定向越野活动</title>
    ...
    <script>
        function replaceDoc() {
window.location.replace("./10.php")    </script>
...
"pic/10.png"                     id="activity_pic"></div>
                <div class="UpText">
                    <div>活动名称：
男生节 · 趣味定向越野活动 </div>
                    <div>活动时间：
...
法学院学生会   </a></div>
                    <div>官方网页链接：<a href=
"https://mp.weixin.qq.com/s/8PXmUDOqK80ClXyUnLa5yQ"            >
https://mp.weixin.qq.com/s/8PXmUDOqK80ClXyUnLa5yQ        </a>
                    </div>
