...
雅思模考</title>
    ...
    <script>
        function replaceDoc() {
window.location.replace("./27.php")    </script>
...
"pic/27.png"                     id="activity_pic"></div>
                <div class="UpText">
                    <div>活动名称：
雅思模考 </div>
                    <div>活动时间：
...
北京大学学生会   </a></div>
                    <div>官方网页链接：<a href=
"https://mp.weixin.qq.com/s/PyXoEjgpDm4n3X7UMm7zjg"            >
https://mp.weixin.qq.com/s/PyXoEjgpDm4n3X7UMm7zjg        </a>
                    </div>
