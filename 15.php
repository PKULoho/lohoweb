...
Allen & Overy主题演讲赛</title>
    ...
    <script>
        function replaceDoc() {
window.location.replace("./15.php")    </script>
...
"pic/15.png"                     id="activity_pic"></div>
                <div class="UpText">
                    <div>活动名称：
Allen & Overy主题演讲赛 </div>
                    <div>活动时间：
2020年2月7日 </div>
                    <div>活动主办方：<a href="activity_host.html">
法学院学生会   </a></div>
                    <div>官方网页链接：<a href=
"https://mp.weixin.qq.com/s/_QisbnAG5eIMW_qnnt68sg"            >
https://mp.weixin.qq.com/s/_QisbnAG5eIMW_qnnt68sg        </a>
                    </div>
