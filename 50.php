...
外院&数院新生定向赛</title>
    ...
    <script>
        function replaceDoc() {
window.location.replace("./50.php")    </script>
...
"pic/50.png"                     id="activity_pic"></div>
                <div class="UpText">
                    <div>活动名称：
外院&数院新生定向赛 </div>
                    <div>活动时间：
...
数院学生会   </a></div>
                    <div>官方网页链接：<a href=
"https://mp.weixin.qq.com/s/xy66wzB-1SoM2q2AlbiOeQ"            >
https://mp.weixin.qq.com/s/xy66wzB-1SoM2q2AlbiOeQ        </a>
                    </div>
