...
北大十佳初赛</title>
    ...
    <script>
        function replaceDoc() {
window.location.replace("./28.php")    </script>
...
"pic/28.png"                     id="activity_pic"></div>
                <div class="UpText">
                    <div>活动名称：
北大十佳初赛 </div>
                    <div>活动时间：
...
北京大学学生会   </a></div>
                    <div>官方网页链接：<a href=
"https://mp.weixin.qq.com/s/sISoCj51Zck225B0eoa4kg"            >
https://mp.weixin.qq.com/s/sISoCj51Zck225B0eoa4kg        </a>
                    </div>
