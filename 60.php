...
摄影班 | 基础班报名    </title>
    ...
    <script>
        function replaceDoc() {
window.location.replace("./60.php")        }
    </script>
</head>
...
"pic/60.png"                      id="activity_pic"></div>
                <div class="UpText">
                    <div>活动名称：
摄影班 | 基础班报名                </div>
                    <div>活动时间：
...
北京大学青年摄影学会                    </a></div>
                    <div>官方网页链接：<a href=
"https://mp.weixin.qq.com/s/jLAMzJlQcR1PJXBmNdPmSA"                        >
https://mp.weixin.qq.com/s/jLAMzJlQcR1PJXBmNdPmSA                    </a>
                    </div>
                    <div>评分：10.0</div>
